...
- Run create_gpt_timeline.py
  ...
  * This will create a new timeline (**projectname_timelines_gpt.csv**) having the GTP events for each identified PR as assistance.
...
- collect_gpt_pr_at_resolution.py
  * This will collect the data required for answering RQ1. This data is used in a R code that is found in this repository (https://anonymous.4open.science/r/GPT-Assistance-PR-C756/R/Readme.txt)
...
- get_gpt_pr_distance.py
  ...
  * The output file is used in a R program that is found in this repository (https://anonymous.4open.science/r/GPT-Assistance-PR-C756/R/Readme.txt) to check whether the PRs are similar or not.
